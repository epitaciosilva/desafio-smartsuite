# Generated by Django 3.1.7 on 2021-06-23 00:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client_type', models.PositiveSmallIntegerField(choices=[(1, 'Regular'), (2, 'Reward')], verbose_name='Client Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.PositiveIntegerField(verbose_name='Reserve Number')),
                ('name', models.CharField(max_length=255, verbose_name='Name')),
                ('email', models.EmailField(max_length=254, verbose_name='Email')),
                ('telephone', models.CharField(max_length=11, validators=[django.core.validators.MinLengthValidator(11)], verbose_name='Telefone')),
                ('client_type', models.PositiveSmallIntegerField(choices=[(1, 'Regular'), (2, 'Reward')], verbose_name='Client Type')),
